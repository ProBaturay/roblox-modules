...
TextLabel7.Text = "The scale is determined by dividing the \"Thickness\" property to the size that is lower than the other dimension's size.<br/><br/>For instance, a <b>GuiObject</b>, whose X-component is 50, would be scaled in accordance with the number <b>0.04</b>, if its <b>UIStroke</b> had 2-pixel thickness.<br/><br/>You have to scale them while you have the viewport size adjusted at the desired."
